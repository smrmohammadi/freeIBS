...
{
    function AddPrefix($tariff_name,$prefix_names,$prefix_codes,$cpms,$free_seconds,$min_durations,$round_tos)
    {
...
{
    function UpdatePrefix($tariff_name,$prefix_id,$prefix_name,$prefix_code,$cpm,$free_seconds,$min_duration,$round_to)
    {
...
{
    function GetTariffInfo($tariff_name,$include_prefixes=True)
    {
