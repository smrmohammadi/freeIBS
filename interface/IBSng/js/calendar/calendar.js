...
// sets the time in date object to 0:0:0.0
...
Date.prototype.getMonthDays = function(month) {
        ...
        if(this.DateType == 'J'){ // if the calendar is Jalali
...
Date.prototype.getWeekNumber = function() {
        ...
        if(this.DateType == 'J')
        {
            ...
            d.__old_setMonth(0);
            d.__old_setDate(4); // Thu in Week 1
...
// changes the date system,
// select between Jalali or Gregorian
Calendar.prototype.setDateSystem = function(c){
    if(c == 'J'){
        // set jalali date properties
        this.minYear = 1380;
        this.maxYear = 1400;
