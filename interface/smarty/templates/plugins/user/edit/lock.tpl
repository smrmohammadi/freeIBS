...
{viewTable title="User Lock" table_width="380" nofoot="TRUE"} 
	...
	<input type=checkbox name="has_lock" value="t" class=checkbox {if attrDefault($user_attrs,"lock","has_lock")!=""}checked{/if} onClick='lock_select.toggle("lock")'>
...
{if attrDefault($user_attrs,"lock","has_lock")!=""}
