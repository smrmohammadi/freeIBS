...
{listTable no_header=TRUE no_foot=TRUE table_width="100%"} 
	...
	{multiTableTR}
	    ...
	    {reportToShowCheckBox name="show__voip_username" output="VoIP Username" default_checked="TRUE" always_in_form="search" value="voip_username" form_name="search_user" container_name="attrs"}
	    ...
	    {reportToShowCheckBox name="show__voip_charge" output="VoIP Charge" default_checked="FALSE" always_in_form="search" value="voip_charge" form_name="search_user" container_name="attrs"}
