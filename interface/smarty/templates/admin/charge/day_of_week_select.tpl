	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="List_Title">
			<tr>
				...
				<td class="List_Title" rowspan="2"><nobr>Days of Week&nbsp;<img border="0" src="/IBSng/images/arrow_orange.gif" width="10" height="10"></td>
				<td class="List_Title_End" rowspan="2"><img border="0" src="/IBSng/images/end_of_list_title_red.gif" width="5" height="20"></td>
				<td class="List_Title_Top_Line" align="RIGHT"><nobr><input style="height:11" class="checkbox" type=checkbox name="checkall">checkall</td>
			</tr>
			<tr>
    ...
    {foreach from=$day_of_weeks key=index item=day_of_week}
		...
		<td class="Form_Content_Row_Begin"><img border="0" src="/IBSng/images/begin_of_row_light.gif"></td>
		<td class="Form_Content_Row_Left_light" style="width:5"><nobr>
