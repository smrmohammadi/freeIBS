	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="List_Title">
			<tr>
				...
				<td class="List_Title" rowspan="2"><input type=radio name=ras value="{$ras_ip}"  {if $ras_selected eq $ras_ip} checked {/if} onClick="ras_select.select('{$ras_ip}')">
				RAS {$ras_ip}&nbsp;<img border="0" src="/IBSng/images/arrow/arrow_orange_on_red.gif" width="10" height="10"></td>
				<td class="List_Title_End" rowspan="2"><img border="0" src="/IBSng/images/list/end_of_list_title_red.gif" width="5" height="20"></td>
				<td class="List_Title_Top_Line" align="RIGHT"><input style="height:11" class="checkbox" type=checkbox name="{$ras_ip_escaped}_ALL_" {ifisinrequest name="`$ras_ip_escaped`_ALL_" default_var="`$ras_ip`_ALL_" default="" value="checked"}>All Ports {$ras_ip}</td>
			</tr>
			<tr>
