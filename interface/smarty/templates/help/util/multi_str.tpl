...
1. ",": seperate each string member of multi str. ex: 1,2,3 will be expanded to "1 2 3"
2. ranges: You can specify a range in multi str. 
   ex: name{1-6} will  be expanded to "name1 name2 name3 name4 name5"
   ranges are start inclusive but end exclusive. if a range is more that 1 digit
