...
*/
	...
	$header=<<<END
<table class="Form_Main" width="380" border="0"  cellspacing="0" bordercolor="#000000" cellpadding="0">
	<tr>
		<td colspan="7">
		...
		<table border="0" cellspacing="0" cellpadding="0" class="Form_Title">
			<tr>
				...
				<td class="Form_Title_red" rowspan="2" style="width:175">{$title} <img border="0" src="/IBSng/images/arrow/arrow_orange_on_red.gif"></td>
