...
class DayOfWeekString:
	...
	try:
	    ...
	    raise GeneralException(errorText("GENERAL","INVALID_DAY_OF_WEEK",0)%dow_str)

class DayOfWeekIntContainer:
    """
	This class used in intervals to keep multiple day of weeks (multi DayOfWeekInt instances)
    """
