...
class HandlersManager:
	...
	if name in self.__handler_instances:
	...
	try:
	    ...
	    self.__returnError(str(e))
	except GeneralException,e:
	    self.__returnError(str(e))
	except DBException,e:
	    self.__returnError(str(e).split("\n")[0])
	except Exception,e:
	...
	"""
	return request.Request(handler_obj,method,params,client_address)
	...
	"""
	if isinstance(handler_ret_val,response.Response):
